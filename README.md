docker build -f dockerfile-ubuntu -t ubuntu:22.04 .
...
打开PyCharm，选择"File" > "Settings"（对于Mac用户是"PyCharm" > "Preferences"）。

在设置窗口中，选择"Project" > "Python Interpreter"。

选择你正在使用的解释器。

在右侧的"Pip"选项卡中，找到"Pip repository"设置。

点击"..."按钮，选择"Add"。

在弹出的窗口中，输入国内镜像源的URL。以下是一些常用的国内镜像源URL：
