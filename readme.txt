...
4. edit configuration to set the parameter for run （edit demo->edit configuration->script parameter : ./voice/2796798189.mp3)
5. run and wait for the output, it takes around 10 seconds for 5 mins audio files, enjoy
...
cd ~/demo/ && docker exec -u root -t whisper bash -c "cd /root/demo && ./decode.sh 